...
/**
 *  Replace the ad tag parameters to be used for the upcoming ad requests for a live stream.
 *  Note that this call is a no-op for VOD streams.
 *
 *  @param adTagParameters   the updated ad tag parameters for the current stream.
 */
