...
public typealias MovieMakerCompletion = (URL) -> Void
typealias MovieMakerUIImageExtractor = (AnyObject) -> UIImage?


public class ImagesToVideo: NSObject{
    ...
    var movieMakerUIImageExtractor:MovieMakerUIImageExtractor?
    ...
    public init(videoSettings: [String: Any]) {
        ...
        // 表示影片時間的類別 CMTimeMake(time, timeScale)
        // 表達的時間就會是 time / timeScale 才會是秒.
        self.frameTime = CMTimeMake(60, 30)
//        CMTimeMakeWithSeconds(<#T##seconds: Float64##Float64#>, <#T##preferredTimescale: Int32##Int32#>)
    ...
    public func createMovieFrom(images: [UIImage], completion: @escaping MovieMakerCompletion){
        self.createMovieFromSource(images: images, extractor: {
